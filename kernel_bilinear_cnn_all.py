...
#torch.save(sketch_matrix01,'/cvdata/xuelu/CUB_200_2011/bilinear-cnn1/src/sketch_matrix1_8092.pth')
#torch.save(sketch_matrix02,'/cvdata/xuelu/CUB_200_2011/bilinear-cnn1/src/sketch_matrix2_8092.pth')
#torch.save(sketch_matrix03,'/cvdata/xuelu/CUB_200_2011/bilinear-cnn1/src/sketch_matrix3_8092.pth')
#torch.save(sketch_matrix04,'/cvdata/xuelu/CUB_200_2011/bilinear-cnn1/src/sketch_matrix4_8092.pth')
#pdb.set_trace()
...
#            filter(lambda p: p.requires_grad,self._net.parameters()), lr=self._options['base_lr'],
...
# Save model onto disk.
                torch.save(self._net.state_dict(),
                           os.path.join('/media/tiantong/Drive/Xuelu/CUB_200_2011/bilinear-cnn1/model',
                                        'kernel_ft_vgg_16_epoch_%d.pth' % (t + 1)))
...
def main():
    ...
    path = {
        'model': os.path.join(project_root, 'model', 'kernel_vgg_16_epoch_30.pth'),
    }
    for d in path:
        if d == 'model':
